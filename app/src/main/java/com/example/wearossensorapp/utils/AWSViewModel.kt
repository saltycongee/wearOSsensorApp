...
class AWSViewModel : ViewModel(){
    ...
    companion object {
        ...
        private const val CUSTOMER_SPECIFIC_ENDPOINT = "a2sno6esl9wxbt-ats.iot.ca-central-1.amazonaws.com"

        // Cognito pool ID. For this app, pool needs to be unauthenticated pool with
        // AWS IoT permissions.
        private const val COGNITO_POOL_ID = "ca-central-1:1eb81253-5646-4a56-9b85-56ff47578b1e"

        // Name of the AWS IoT policy to attach to a newly created certificate
        private const val AWS_IOT_POLICY_NAME = "HealthMonitoringAppWearOS-IoTPolicy-D1ELSGAOXUQ"
